...
;print, red, green, blue
      ...
      red = [red, 70, 200, 255,  153]
      green = [green, 70, 200, 191, 51]
      blue = [blue, 70, 200,  92,  0]
...
;for ii=0,26 do print, ii,red[ii],green[ii],blue[ii]
      ...
      icolor = 0 * (color EQ 'black') $
             ...
             + 5 * (color EQ 'orange') $
             + 29* (color EQ 'light orange') $
             + 30* (color EQ  'dark orange') $
             + 6 * (color EQ 'green') $
